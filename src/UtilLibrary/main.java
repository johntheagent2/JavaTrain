...
class main{
    public static void main(String[] args) throws IOException {
        ...
        ResourceBundle labelsUS = ResourceBundle.getBundle("UtilLibrary/lang/label", localeEn);
        ResourceBundle labelsVN = ResourceBundle.getBundle("UtilLibrary/lang/label", localeVn);
